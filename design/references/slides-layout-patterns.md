...
python /home/user/claude-skills/design-system/scripts/search-slides.py "metrics dashboard" -d layout

# Contextual recommendation
python /home/user/claude-skills/design-system/scripts/search-slides.py "traction slide" \
