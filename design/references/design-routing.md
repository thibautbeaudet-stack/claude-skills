...
**Brand:**
```bash
node /home/user/claude-skills/brand/scripts/inject-brand-context.cjs
node /home/user/claude-skills/brand/scripts/validate-asset.cjs <path>
```

**Tokens:**
```bash
node /home/user/claude-skills/design-system/scripts/generate-tokens.cjs -c tokens.json
node /home/user/claude-skills/design-system/scripts/validate-tokens.cjs -d src/
```
