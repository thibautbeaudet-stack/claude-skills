...
python /home/user/claude-skills/design-system/scripts/search-slides.py "investor pitch" -d strategy

# Get emotion arc
python /home/user/claude-skills/design-system/scripts/search-slides.py "series a funding" -d strategy --json
```
